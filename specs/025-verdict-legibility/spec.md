...
**Research Note**: `docs/research/13-legibility.md` (DEC-11 gate for **US2 only** — decides the preview honesty rules; US1/3/4/5 build on the note-09 presentation audit already banked)
